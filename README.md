...
- 🔭 **Currently building:** [API Traffic Guard](https://github.com/EliorYomTov/api-traffic-guard) - a real-time API protection layer with rate limiting and brute-force detection. Java 21, Spring Boot, PostgreSQL, Redis.
